...
const { GetSingleClassMarksheetTemplateByStream, GetSingleClassMarksheetTemplateStructureByStream, GetSingleMarksheetTemplateById, CreateExamResultStructure, DeleteResultStructure } = require('../controllers/exam-result-structure');
