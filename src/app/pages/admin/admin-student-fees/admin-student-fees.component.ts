...
export class AdminStudentFeesComponent implements OnInit {
  ...
  private getPrintContent(): string {
    ...
    printHtml += '.logo { height: 75px;margin-top:15px;margin-left:10px;}';
    printHtml += '.school-name {display: flex; align-items: center; justify-content: center; text-align: center; }';
    printHtml += '.school-name h3 { color: #252525 !important; font-size: 20px !important;font-weight: bolder;margin-top:-125px !important; margin-bottom: 0 !important; }';

    printHtml += '.address{margin-top: -45px;}';
    printHtml += '.address p{font-size:12px;margin-top: -12px !important;}';
    printHtml += '.title-lable {text-align: center;margin-top: -10px;margin-bottom: 0;}';
    printHtml += '.title-lable p {color: #252525 !important;font-size: 16px;font-weight: bold;letter-spacing: .5px;}';

    printHtml += '.info-table {width:100%;color: #252525 !important;border: none;font-size: 14px;margin-top: -8px;margin-bottom: 3px;padding-top:3px;display: inline-table;}';
    ...
    printHtml += '.custom-table th{height: 25px;text-align: center;border:1px solid #9e9e9e;line-height:15px;font-size: 14px;}';
    printHtml += '.custom-table tr{height: 25px;}';
    printHtml += '.custom-table td {text-align: center;border:1px solid #9e9e9e;font-size: 14px;}';
    printHtml += '.text-bold { font-weight: bold;}';
    printHtml += '.text-left { text-align: left;}';
    printHtml += 'p {color: #252525 !important;font-size:15px;}'
